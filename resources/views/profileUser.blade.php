                ...
                <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ url()->previous() }}" class="nav-link text-white font-weight-bold px-0">
        ...
        <div class="container-fluid py-4">
                                ...
                                <li class="list-group-item border-0 d-flex p-4 mb-2 border-radius-lg">
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="text-xs">Github: <span
                                                class="text-dark ms-sm-2 font-weight-bold">github.com/{{ $user->github }}</span></span><br>
                                        <span class="mb-2 text-xs">PIX: <span
                                                class="text-dark ms-sm-2 font-weight-bold">{{ $user->pix}}</span></span>
                                        <span class="mb-2 text-xs">Criou a conta em: <span
                                                class="text-dark ms-sm-2 font-weight-bold">{{ $user->created_at->format('d/m/Y')}}</span></span>
                                    </div>
            ...
            <aside class="jogosUser">
                <div class="col mt-4">
                    <div class="card">
                        <div class="card-header pb-0 px-3">
                            <h6 class="mb-0">Jogos cadastrados <span></span></h6>
                        </div>
